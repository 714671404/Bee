...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    data: function data() {
        return {
            messages: [{ id: 1, img: '', title: '哈佛大学用12张图，教育了10亿人_心灵鸡汤', content: '很多人把感恩当成一种付出，其实感恩本身就是一种幸福。...' }, { id: 2, img: '', title: '梳子能卖给和尚,你信吗？而所谓的营销到底是什么？', content: '今天和大家分享一个营销的理念！也是我从别的渠道看到的觉得非常不错，分享给大家！ 有一个营销经理想考考他的手下，就给他们出了一道题，把梳子卖给和尚。 第一个人：出了门...' }, { id: 3, img: '', title: '为什么男人喜欢绿茶表,这让女汉子如何活呀……', content: '今天咱们来谈谈绿茶婊 绿茶婊 泛指那些外表清新脱俗， 内心工于心计的女子。 很多妹纸在后台哭诉， 为什么好男人都喜欢绿茶婊？ 她都骚的那么明显了为什么男人还觉得纯？ 男人为...' }, { id: 4, img: '', title: '【力荐】一个北漂五年的人告诉你，为什么二十多岁的你要努力.满满的正能量', content: '很多人把感恩当成一种付出，其实感恩本身就是一种幸福。...' }, { id: 5, img: '', title: '哈佛大学用12张图，教育了10亿人_心灵鸡汤', content: '很多人把感恩当成一种付出，其实感恩本身就是一种幸福。...' }, { id: 6, img: '', title: '哈佛大学用12张图，教育了10亿人_心灵鸡汤', content: '很多人把感恩当成一种付出，其实感恩本身就是一种幸福。...' }]
        };
    }
});
